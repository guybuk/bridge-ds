...
class PanelVideo(DisplayEngine):
    ...
    def _create_video_player(self, frames, fps):
        import panel as pn

        player_wig = pn.widgets.Player(
            name="Player", start=0, end=len(frames) - 1, value=0, loop_policy="loop", interval=1000 // fps
        )
